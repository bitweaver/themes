...
{* This is always showing up if we do $gBitThemes->loadAjax('mochikit'). Can't seem to figure out how to get smarty to do the right thing... -Nick	{foreach from=$gBitThemes->mAjaxLibs item=ajaxLib}
