...
function smarty_function_biticon( $pParams, &$gBitSmarty, $pCheckSmall = FALSE ) {
	...
	if( $pParams['ipackage'] == 'icons' ) {
		...
		if( FALSE !== ( $matchFile = biticon_first_match( BIT_ROOT_PATH."styles/icons/$icon_style".$pParams['ipath'], $pParams['iname'] ))) {
			return biticon_output( $pParams, BIT_ROOT_URL."styles/icons/$icon_style".$pParams['ipath'].$matchFile );
		}

		if( $icon_style != DEFAULT_ICON_STYLE && FALSE !== ( $matchFile = biticon_first_match( BIT_ROOT_PATH."styles/icons/".DEFAULT_ICON_STYLE.$pParams['ipath'], $pParams['iname'] ))) {
			return biticon_output( $pParams, BIT_ROOT_URL."styles/icons/".DEFAULT_ICON_STYLE.$pParams['ipath'].$matchFile );
		}
